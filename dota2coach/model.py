...
Это компактный «общий язык» обзорного анализа. Текущий OpenDota-источник отдаёт
эти объекты; будущий Replay Intelligence Engine сможет строить из полного
хранилища совместимую проекцию `Match`, но его точные данные будут доступны и
через отдельный query-contract. FeatureExtractor и BundleBuilder зависят только
от этой модели и не знают происхождения обзорных фактов.
