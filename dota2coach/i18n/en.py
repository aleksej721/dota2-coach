...
UI = {
    ...
    "explorer.metric.kp": "Kill participation",
    "explorer.metric.networth": "Final net worth",
    "explorer.metric.last_hits": "Last hits / denies",
    ...
    "explorer.chart.gold": "Gold advantage",
    "explorer.chart.xp": "XP advantage",
    ...
    "explorer.signals.note":
        "These are statistical signals, not verdicts. The coach prompt checks agency and causality first.",
    "explorer.signal.strength": "Strong statistical signal",
    "explorer.signal.inspect": "Worth inspecting in the review",
    "explorer.signal.percentile": "{metric}: {value} · {percentile}th percentile",
    "explorer.signals.empty": "No reliable hero benchmarks are available for this match.",
    "explorer.scoreboard.title": "All players",
    "explorer.scoreboard.sub": "Final stats · ★ marks the selected POV",
    "explorer.scoreboard.hero": "Hero",
    "explorer.scoreboard.role": "Role",
    "explorer.scoreboard.kda": "K / D / A",
    "explorer.scoreboard.lh_dn": "LH / DN",
    "explorer.scoreboard.gpm_xpm": "GPM / XPM",
    "explorer.scoreboard.networth": "Net worth",
    "explorer.scoreboard.damage": "Damage",
    "explorer.draft.title": "Draft",
    "explorer.draft.sub": "Pick order when the source preserved it",
    ...
    "explorer.objectives.title": "Objectives",
    "explorer.objectives.sub": "Roshan, buildings and key events",
    "explorer.objective.firstblood": "First blood",
    "explorer.objective.building": "Building destroyed",
    "explorer.objective.roshan": "Roshan",
    "explorer.objective.aegis": "Aegis",
    ...
    "explorer.empty": "No events of this type are available in the data.",
    "explorer.metric.gold_per_min": "GPM",
